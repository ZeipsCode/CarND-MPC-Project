...
N is the number of datapoints taken into consideration for future vehicle states. 
dt describes the timestep between two consecutive states.

So therefore increasing N and a decreasing dt should result in a better result. Values of N = 10 and dt = 0.1 are given in class and work pretty well.
